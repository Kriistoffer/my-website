...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="scroll-mt-28 mb-28 sm:mb-40">
      ...
      {/* TODO: Animations currently broken in this version of Next.js -- look up workarounds or replace with something else. Not priority as everything but the animiations work. */}
